...
import { CITIES, CITY_MAP, MAP_WIDTH, MAP_HEIGHT } from '../../shared/src/boardData';
...
function attachPanzoom(svgEl: SVGSVGElement, viewport: SVGGElement, wrapEl: HTMLElement): PanZoom {
...
export function initMap(svgEl: SVGSVGElement, wrapEl: HTMLElement): MapController {
  svgEl.innerHTML = `
    <g class="viewport">
...
export function renderMap(
  ...
  for (const city of CITIES) {
    for (const conn of city.connections) {
      ...
      const isLegalMove = myLocation != null && (city.id === myLocation || conn === myLocation);
      edgesSvg.push(
